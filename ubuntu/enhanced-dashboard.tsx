        ...
        <>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <CardContent>
                <div className="text-2xl font-bold">{summary.activeWorkOrders}</div>
            ...
            >
              ...
              <CardContent>
                <div className="text-2xl font-bold">{summary.openIssuesCount}</div>
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentActivities.map((activity) => (
                    <div key={activity.id} className="flex items-start space-x-4 p-2 hover:bg-slate-50 rounded-md">
                      <div className="bg-slate-100 p-2 rounded-full">
                        {activity.type === 'project' && <Briefcase className="h-4 w-4" />}
                        {activity.type === 'workorder' && <Construction className="h-4 w-4" />}
                        {activity.type === 'issue' && <AlertCircle className="h-4 w-4" />}
                        {activity.type === 'document' && <Calendar className="h-4 w-4" />}
                      </div>
                      <div className="flex-1">
                        <p className="text-sm font-medium">
                          {activity.item} <span className="text-slate-500">was {activity.action}</span>
                        </p>
